...
<!-- VISITOR COUNTER -->
<br/>
<img src="https://komarev.com/ghpvc/?username=HenriqueHintz&label=Profile%20Views&color=58A6FF&style=for-the-badge&labelColor=0d1117" alt="Profile Views"/>
<img src="https://img.shields.io/github/followers/HenriqueHintz?label=Followers&style=for-the-badge&color=58A6FF&labelColor=0d1117" alt="Followers"/>
...
const henrique = {
    ...
    foco: "Aplicações web de alto padrão para negócios reais",
    stack: ["TypeScript", "React", "Next.js", "Vite", "Tailwind CSS"],
    diferencial: "Cada projeto no meu GitHub atende ou simula um negócio real",
    objetivo: "Consolidar carreira como Desenvolvedor Fullstack em projetos de impacto"
};
```

- 🏗️ Desenvolvo **soluções web completas** para empresas dos setores de **gastronomia, fitness e bem-estar**
- ⚡ Stack principal: **TypeScript + React/Next.js** com deploy em **Vercel**
- 🎯 Foco em **alta performance, conversão e experiência mobile-first**
- 📈 Cada projeto é pensado como um **produto real**, com UX profissional e SEO otimizado
- 🔭 Estudando **Java** e **Go** para expandir atuação no backend
...
<div align="center">
  <img height="170em" src="https://github-readme-stats.vercel.app/api?username=HenriqueHintz&show_icons=true&theme=github_dark&hide_border=true&bg_color=0d1117&title_color=58A6FF&icon_color=58A6FF&text_color=c9d1d9&ring_color=58A6FF&include_all_commits=true&count_private=true"/>
  <img height="170em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=HenriqueHintz&layout=compact&theme=github_dark&hide_border=true&bg_color=0d1117&title_color=58A6FF&text_color=c9d1d9&langs_count=8"/>
</div>

<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com?user=HenriqueHintz&theme=github-dark-blue&hide_border=true&background=0d1117&stroke=58A6FF&ring=58A6FF&fire=58A6FF&currStreakLabel=58A6FF&sideLabels=c9d1d9&currStreakNum=c9d1d9&dates=8B949E" alt="GitHub Streak" />
</div>
...
> Diferente de repositórios genéricos ou tutoriais, meus projetos são desenvolvidos para **atender demandas reais de empresas**. Cada solução abaixo foi arquitetada pensando em **conversão, performance e experiência do usuário final** — exatamente como um desenvolvedor atua no mercado.
...
| **[Churrascaria Gauchá](https://github.com/HenriqueHintz/churrascaria-gaucha)** | 🥩 Churrascaria | Plataforma com reservas online, Dark/Light mode, Shadcn/UI, micro-animações Framer Motion, compliance legal (Termos/Privacidade) e SEO Ready. | `TypeScript` `Next.js` `Shadcn` | [Live](https://churrascaria-gaucha.vercel.app) |
| **[El Chicano Pocket](https://github.com/HenriqueHintz/el-chicano)** | 🌮 Restaurante Mexicano | App de alta performance com cardápio interativo, suporte multi-unidades (Florianópolis/Laguna), carrinho de pedidos, Google Analytics e prova social. | `JavaScript` `Next.js` `Tailwind` | [Live](https://el-chicano-two.vercel.app) |

</div>

### 📌 O que esses projetos demonstram na prática:

- ✅ **Entrega completa** — do design à produção com deploy em Vercel
- ✅ **Foco em conversão** — CTAs estratégicos, integração WhatsApp, funis de venda
- ✅ **Performance real** — Lighthouse scores otimizados, Lazy Loading, Code Splitting
- ✅ **Padrão de mercado** — Componentes modulares, tipagem TypeScript, arquitetura limpa
- ✅ **Responsividade total** — Mobile-first em todos os projetos
- ✅ **SEO profissional** — Meta tags dinâmicas, OpenGraph, sitemap
...
<a href="https://www.instagram.com/henriquehtz/" target="_blank">
...
<a href="mailto:contato@henriquehintz.dev" target="_blank">
...
**"Não construo projetos para preencher portfólio — construo soluções que negócios reais precisam."**

<sub>⭐ Se algum projeto chamou sua atenção, considere deixar uma star!</sub>
